        ...
        <div id="calendar">
            ...
            <div id="menu-content">
              <div className="madeBy">
                <div className="madeOverlay">
                  <span id="madeName">Claire H. Borwick</span>
                  <span id="madeInfo">Korean-English - KR/EN</span>
                  <span id="madeWeb">
                    <a target="_blank" href="https://hwaislazy.github.io">
                      <i className="fa fa-github" aria-hidden="true"></i>Github
                    </a>
                  </span>
                  <span id="madeWeb">
                    <a target="_blank" href="https://codepen.io/hwaislazy">
          ...
          <div id="add_entry">
            <div className="enter_entry">
              <input type="text" placeholder="Title here..." id="entry_name" />
              <span
                id="save_entry"
